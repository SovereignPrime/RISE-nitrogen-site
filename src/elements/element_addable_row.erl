...
render_element(Record = #addable_row{id=Id, num=N, body=Body, class=Class}) ->
    #panel{id= wf:to_atom(wf:f("~s_addable~p", [Id, N])), class=[Class, "row-fluid", "addable-row"], body=[
        #panel{class="span11", style="width:97%;", body=[Body]},
        #panel{class="span1", style="text-align:right;width:1%;margin-left:1%;",  body=[
            #button{
